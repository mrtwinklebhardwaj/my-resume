...
const IntroCard = () => {
  return (
    ...
    <p className="text-center text-[16px] text-[#fff] ">Product Desinger/Developer.</p>
    <p className="text-center text-[16px] text-[#fff] mb-4"><i className="ri-map-pin-line text-white"></i> Noida, India.</p>
